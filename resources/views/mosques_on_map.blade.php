...
<html lang="en">
	...
	<!-- Header Area Start -->
      ...
      <section class="slider-area gallery-slider-area">
         <div class="sliderr">
            <div class="single-slide" style="background-image:url('assets/img/new/mosque1.jpg')">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-12">
