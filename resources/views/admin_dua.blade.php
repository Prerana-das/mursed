...
@section('content')
	...
	<div class="content">
		<div class="container">
			<button type="button" class="_btn _action_btn add_btn _mar_b30" data-toggle="modal" data-target="#createModal">
				<i class="fa fa-plus-circle"></i>&nbsp;Add Dua
			</button>
					...
					<table class="_table">
						...
						<tr @foreach($video as $rowww)>
							...
							<td>
								...
								<a href="{{action('PrayerController@delDua',['id' => $rowww->id])}}" class=" _btn _action_btn make_btn1" >Delete</a>
							</td>
						</tr @endforeach>
							<!-- ITEMS -->
					</table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-plus-square"></i> Add Dua</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{action('PrayerController@saveDua')}}" method="post" enctype="multipart/form-data">
	...
	<div class="modal modal_zindex fade" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-plus-square"></i>Edit Dua</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{action('PrayerController@editDua')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
