      ...
      <!-- Slider Area End -->
				...
				<section class="experience-area pt-50 pb-50">
					<div class="container">
						<div class="row">
						<div class="col-md-4">
	<a href="shahadah.html"><div class="single-exp">
						...
						<div class="col-md-4">
	<a href="salaat.html"><div class="single-exp">
						...
						<div class="col-md-4">
	<a href="sawm.html"><div class="single-exp">
								<img src="assets/img/icons/food.png" alt="img" />
								<h2>Sawm</h2>
								<p>Although AL-Murshed Android App includes Zakaat Calcultor, Many users who don't use Android device requested to offer Online Calculator beside App. And by the will of ALLAH it was accomplished. .</p>
							</div>
						</a>	
							...
							<div class="col-md-4">
	<a href="zakaat.html"><div class="single-exp">
							...
							<div class="col-md-4">
	<a href="hajj.html"><div class="single-exp">
