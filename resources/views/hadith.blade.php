...
<html lang="en">
	...
	<!-- Header Area Start -->
      ...
      <section class="slider-area gallery-slider-area">
         <div class="sliderr">
            <div class="single-slide" style="background-image:url('assets/img/new/20.jpg')">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-12">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
						...
						<img src="assets/img/icons/book.png" alt="img" />
							...
							<div class="modal-dialog">   <div class="modal-content">    <div class="modal-header"><h1>{{$rowww->title}}</h1>              
								</div>
								<div class="modal-body">  <p>{{$rowww->description}}</p>
									<h1>{{$rowww->reference}}</h1>							   
								</div>
								...
								<a href="#" class="box-btn" data-toggle="modal" data-target="#myModal">view hadith</a>
						</div>
                     </div>
					 @endforeach
                  </div>
