...
<html lang="en">
	...
	<!-- Header Area Start -->
      ...
      <section class="slider-area gallery-slider-area">
         <div class="sliderr">
            <div class="single-slide" style="background-image:url('assets/img/new/19.jpg')">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-12">
                  ...
                  <div class="row">
							<div class="col-sm-12">
								<div class="section-title text-center pb-50">
									<h2>Watch videos here</h2>
								</div>
							</div>
					@foreach($video as $rowww)
                     <div class="col-md-4">
						<div class="single-exp">
						<?php echo trim($rowww->link, '"') ?>
						<!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/-24zBDFTG28" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
						</div>
                     </div>
					 @endforeach
