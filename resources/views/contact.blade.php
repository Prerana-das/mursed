	...
	<!-- Header Area Start -->
		<div class="container-fluid">
			...
			<!-- Side-menu bar -->
				...
				<div class="col-md-10">
					<!-- Slider Area Start -->
      <section class="slider-area gallery-slider-area pb-50">
         <div class="sliderr">
            <div class="single-slide" style="background-image:url('assets/img/new/21.jpg')">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-12">
				...
				<div class="row">
					...
					@endif
						<div class="contact-form-area">
							...
							<form action="{{action('PrayerController@addContactMessage')}}" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
								...
								<textarea cols="30" rows="10" placeholder="Your Message" name="description"></textarea>
								<div class="con-form-adiv"><input type="submit" value="Send Message" class="aa"></div>
							</form>
						</div>
					</div>
				</div>
